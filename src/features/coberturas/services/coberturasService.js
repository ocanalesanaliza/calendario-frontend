...
export async function getCoberturas(params = {}) {
  ...
  if (!res.ok) throw new Error(data.detail || 'Error al cargar coberturas')
  return data
}
...
export async function createCobertura(body) {
  ...
  const data = await res.json()
  if (!res.ok) throw new Error(data.detail || 'Error al crear cobertura')
  return data
}
...
export async function getCobertura(id) {
  ...
  const data = await res.json()
  if (!res.ok) throw new Error(data.detail || 'Error al cargar cobertura')
...
export async function updateCobertura(id, body) {
  ...
  const data = await res.json()
  if (!res.ok) throw new Error(data.detail || 'Error al actualizar cobertura')
  return data
}
...
export async function activarCobertura(id) {
  ...
  const data = await res.json()
  if (!res.ok) throw new Error(data.detail || 'Error al activar cobertura')
  return data
}
...
export async function cancelarCobertura(id) {
  ...
  const data = await res.json()
  if (!res.ok) throw new Error(data.detail || 'Error al cancelar cobertura')
  return data
}
...
export async function completarCobertura(id) {
  ...
  const data = await res.json()
  if (!res.ok) throw new Error(data.detail || 'Error al completar cobertura')
  return data
}
